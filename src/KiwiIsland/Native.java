...
public class Native extends Fauna {
    ...
    public Native(int x, int y, String name, String description) {
    ...
    /**
     * Find the middle of X on the grid.
     * 
     * @param x
     * @return 
     */
    ...
    /**
     * Find the middle of Y on the grid.
     * 
     * @param y
     * @return 
     */
